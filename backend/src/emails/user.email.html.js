export const html = (token, redirectBaseLink)=> {
  console.log('sendHtml');
    return `<div class="app font-sans min-w-screen min-h-screen bg-grey-lighter py-8 px-4 text-center">
    ...
    <div class="mail__wrapper max-w-md mx-auto">
      ...
      <div class="mail__content bg-white p-8 shadow-md">
        ...
        <div class="content__body py-8 border-b">
          ...
          <button class="text-white text-sm tracking-wide bg-red rounded w-full my-8 p-4 "><a href='${redirectBaseLink}${token}'>CONFIRM EMAIL ADRESS</a></button>
          <p class="text-sm">
